Recording()
{
	...
	web_url("qsml.aspx_9", 
		...
		"Mode=HTML", 
		EXTRARES, 
		"Url=http://chart.googleapis.com/chart?cht=qr&chs=150x150&choe=UTF-8&chld=H&chl=http://goo.gl/SR00", "Referer=", ENDITEM, 
		"Url=http://chart.googleapis.com/favicon.ico", "Referer=", ENDITEM, 
		LAST);
