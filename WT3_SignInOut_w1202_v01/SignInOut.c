SignInOut()
{
	...
	web_submit_data("SignIn.pl_3", 
		"Action=http://127.0.0.1:1080/cgi-bin/SignIn.pl", 
		"Method=POST", 
		"RecContentType=text/html", 
		...
		"Name=SignIn.x", "Value=35", ENDITEM, 
		"Name=SignIn.y", "Value=6", ENDITEM, 
		LAST);
	...
	web_submit_form("SignIn.pl_4", 
		...
		"Name=username", "Value=jojo01", ENDITEM, 
		"Name=password", "Value=bean", ENDITEM, 
		"Name=SignIn.x", "Value=29", ENDITEM, 
		"Name=SignIn.y", "Value=10", ENDITEM, 
		LAST);
